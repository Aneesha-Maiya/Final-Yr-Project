...
final_transcript = ''
sentence_list = []
for i in range (0,len(transcript1),2):
    # print(transcript1[i]['text'])
    final_transcript = final_transcript + " " + transcript1[i]['text']
    if(i == len(transcript1)-1):
        sentence_list.append(transcript1[i]['text'])
    else:
        sentence_list.append(transcript1[i]['text'] + " " + transcript1[i+1]['text'])
...
for i in range(0,len(sentence_list)):
    text_str = text_str + " " +sentence_list[i] + "."
text_str = text_str.replace("[Music]",'')
print(text_str)
tr4sh.analyze(text_str)
top_sentences = tr4sh.get_top_sentences(len(sentence_list)//2)
print(top_sentences)
generated_summary = ''
for i in range(0,len(top_sentences)):
    generated_summary = generated_summary + top_sentences[i]
